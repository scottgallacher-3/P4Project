...
Using the `ZygoMap` class, users can store and represent surface measurement data captured via interferometry techniques and the proprietary Zygo&reg; software `MetroPro`.
